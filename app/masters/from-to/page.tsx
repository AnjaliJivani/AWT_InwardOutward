        ...
        <div className="p-10 space-y-8 font-sans">
            <header className="flex justify-between items-end">
                <div>
                    ...
                    <h1 className="text-4xl font-bold text-white tracking-tight">From/To Master</h1>
                    <p className="text-slate-400 mt-2 font-medium">Manage frequent senders and recipients for your documents.</p>
                </div>
            ...
            <div className="bg-slate-900/40 backdrop-blur-sm border border-white/10 rounded-[2.5rem] overflow-hidden shadow-sm">
                <div className="p-8 border-b border-white/5 bg-[var(--secondary)]/30 flex items-center justify-between">
                    <h2 className="text-xl font-bold text-white">Registered Contacts</h2>
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {loading || isRefreshing ? (
                                ...
                                <tr key={entry.InOutwardFromToID} className={`hover:bg-[var(--secondary)]/20 transition-colors group ${selectedIds.includes(entry.InOutwardFromToID) ? 'bg-cyan-500/20/30' : ''}`}>
                                    {isSelectionMode && (
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="font-bold text-white leading-tight">{entry.InOutwardFromToName}</p>
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex justify-center">
                                            {entry.IsActive ? (
                                                <div className="flex items-center gap-1.5 text-emerald-600 bg-emerald-500/20 px-3 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider border border-emerald-500/30">
                                                    <CheckCircle2 size={12} />
                                                    Active
                                                </div>
                                            ) : (
                                                <div className="flex items-center gap-1.5 text-rose-600 bg-rose-500/20 px-3 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider border border-rose-500/30">
                                                    <XCircle size={12} />
                                                    Inactive
                                                </div>
                                            )}
                                    ...
                                    <td className="px-8 py-6">
                                        <p className="text-sm text-slate-400 font-medium max-w-xs">{entry.Remarks || "-"}</p>
                                    </td>
                ...
                <div className="p-8 border-t border-white/5 flex items-center justify-between bg-white/5/20 text-sm font-bold text-slate-400">
            ...
            {showForm && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 md:p-6 bg-slate-900/10 backdrop-blur-sm animate-in fade-in duration-300">
                    <div className="bg-slate-900/40 backdrop-blur-sm w-full h-full sm:h-auto sm:max-w-2xl sm:max-h-[90vh] sm:rounded-[2.5rem] flex flex-col border-white/10 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
                        {/* Sticky Header */}
                        <div className="p-6 sm:p-10 border-b border-white/5 flex justify-between items-center bg-[var(--secondary)]/30 shrink-0">
                            <div>
                            ...
                            <button
                                onClick={closeForm}
                                className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full hover:bg-slate-900/40 backdrop-blur-sm/50 text-slate-400 hover:text-white transition-all text-2xl"
                            >
                                &times;
                            </button>
                        </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 sm:p-10 custom-scrollbar">
                            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
                                    <div className="col-span-1 sm:col-span-2">
                                        <div className="flex items-center gap-2 mb-2 sm:mb-3 px-1">
                                            <label className="text-sm font-bold text-slate-200">Entity Name</label>
                                            <Info size={14} className="text-slate-300" />
                                        </div>
                                        <input
                                            type="text"
                                            className="neon-input py-3 sm:py-3.5"
                                    ...
                                    <div className="col-span-1 sm:col-span-2">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 sm:mb-3 px-1">Contact Person</label>
                                        <input
                                            type="text"
                                            className="neon-input py-3 sm:py-3.5"
                                    ...
                                    <div className="col-span-1 sm:col-span-2">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 sm:mb-3 px-1">Full Address</label>
                                        <textarea
                                            className="neon-input min-h-[80px] sm:min-h-[100px] py-3 sm:py-4"
                                    ...
                                    <div className="col-span-1">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 sm:mb-3 px-1">City / Place</label>
                                        <input
                                            type="text"
                                            className="neon-input py-3 sm:py-3.5"
                                    ...
                                    <div className="col-span-1">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 sm:mb-3 px-1">Status</label>
                                        <select
                                            className="neon-input py-3 sm:py-3.5"
                                    ...
                                    <div className="col-span-1 sm:col-span-2">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 sm:mb-3 px-1">Internal Remarks</label>
                                        <textarea
                                            className="neon-input min-h-[60px] sm:min-h-[80px] py-3 sm:py-4"
                                ...
                                {/* Form Actions */}
                                <div className="pt-4 sm:pt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 sticky bottom-0 bg-slate-900/40 backdrop-blur-sm pb-2 sm:pb-0">
                                    <button
                                        type="button"
                                        onClick={closeForm}
                                        className="w-full sm:flex-1 py-3.5 sm:py-4.5 rounded-xl sm:rounded-2xl border border-white/10 font-bold text-slate-300 hover:bg-[var(--secondary)]/50 transition-all text-sm sm:text-base"
                                    >
                                        Cancel
                                    </button>
                                    <button
                    ...
                    <div className="bg-slate-900/40 backdrop-blur-sm w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl border border-white/10 animate-in zoom-in-95 duration-300">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-slate-400 mb-8 leading-relaxed">
                                This action cannot be undone. Are you sure you want to remove <span className="font-bold text-white">"{deletingItem?.name}"</span> from your master directory?
                            </p>
