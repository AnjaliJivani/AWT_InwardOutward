        ...
        <div className="p-10 space-y-8 font-sans">
            <header className="flex justify-between items-end">
                <div>
                    ...
                    <h1 className="text-4xl font-bold text-white tracking-tight">Outward Entry</h1>
                    <p className="text-slate-400 mt-2 font-medium">Record daily dispatches and outgoing mail.</p>
                </div>
            ...
            <div className="bg-slate-900/40 backdrop-blur-sm border border-white/10 rounded-[2.5rem] overflow-hidden shadow-sm">
                <div className="p-8 border-b border-white/5 bg-white/5/20 flex items-center justify-between">
                    <h2 className="text-xl font-bold text-white">Recent Dispatches</h2>
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {loading ? (
                                ...
                                <tr key={entry.OutwardID} className={`hover:bg-white/[0.02] transition-colors group ${selectedIds.includes(entry.OutwardID) ? 'bg-violet-500/20/30' : ''}`}>
                                    {isSelectionMode && (
                                    ...
                                    <td className="px-8 py-6 text-center font-bold text-white">{entry.OutwardNo}</td>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-end bg-slate-900/10 backdrop-blur-sm animate-in fade-in duration-300">
                    <div className="h-full w-full max-w-4xl bg-slate-900/40 backdrop-blur-sm shadow-2xl animate-in slide-in-from-right duration-500 overflow-y-auto">
                        <div className="sticky top-0 z-20 bg-slate-900/40 backdrop-blur-sm/80 backdrop-blur-md p-8 border-b border-white/10 flex justify-between items-center">
                            <div>
                                <h2 className="text-2xl font-bold text-white">{editingId ? "Edit Outward Log" : "New Outward Dispatch"}</h2>
                                <div className="flex items-center gap-4 mt-1">
                                    <span className="text-xs font-bold text-violet-400 bg-violet-500/20 px-2 py-0.5 rounded-md uppercase tracking-wider">
                        ...
                        <form onSubmit={handleSubmit} className="p-10 space-y-10">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="col-span-1">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 px-1">From Office</label>
                                        <select
                                    ...
                                    <div className="col-span-1">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 px-1">Dispatch Date</label>
                                        <input
                                            type="date"
                                    ...
                                    <div className="col-span-2">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 px-1">To (Receiver)</label>
                                        <select
                                            className="neon-input py-3"
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    ...
                                    <div className="col-span-1">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 px-1">Mode</label>
                                        <select
                                            className="neon-input py-3"
                                    ...
                                    <div className="col-span-1">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 px-1">Receipt No</label>
                                        <input
                                            type="text"
                                            className="neon-input"
                                    ...
                                    <div className="col-span-1">
                                        <label className="block text-sm font-bold text-slate-200 mb-2 px-1">Cost (₹)</label>
                                        <input
                                            type="number"
                                            className="neon-input"
                                            placeholder="0.00"
